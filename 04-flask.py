...
class Catalogo: 
    ...
    #------------------------------------------------------------------------------------
    def mostrar_productos(self, codigo):
        #Mostramos datos del producto a partir de su codigo
        producto = self.consultar_productos
        if producto:
            print("-"*40)
...
#Crear instancia del catalogo
catalogo = Catalogo(host='proiettop.mysql.pythonanywhere-services.com', user='proiettop', password='p4ruch0s81', database='proiettop$miapp') 

# Carpeta para guardar las imagenes 
ruta_destino = '/home/proiettop/mysite/static/img/'
...
def mostrar_producto(codigo): 
    ...
    else: return "Producto no encontrado", 404
...
def eliminar_producto(codigo): 
    ...
    producto = catalogo.consultar_productos(codigo) 
    if producto: 
        # Eliminar la imagen asociada si existe ruta_
